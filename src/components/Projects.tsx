...
const initialProjects = [
  {
    ...
    description:
      "Implemented a ride-tracking system for efficient ride assignments using Red-Black Tree and Min Heap, ensuring optimized performance for ride cost and duration tracking.",
  },
  {
    title: "GatorChefs",
    github: "https://github.com/gkishore399/GatorChefs",
    image: "Gatorchefs.jpg",
    technologies: ["Django", "Python", "React JS", "AI"],
    description:
      "Developed a recipe-sharing platform that uses AI to assist users in uploading recipes, generating descriptions, and categorizing ingredients, making recipe sharing easier and faster.",
  },
  {
    ...
    description:
      "Built an efficient e-commerce platform using React and Node.js, with real-time analytics and secure transactions, improving user navigation and inventory management.",
  },
  {
    title: "InstaClone",
    ...
    description:
      "Created an Instagram-like platform where users can upload and share images, follow other users, and interact with posts through likes and comments.",
  },
];
