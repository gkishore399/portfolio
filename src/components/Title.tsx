...
// TitleCTA Component
const TitleCTA: React.FC<TitleCTAProps> = ({
  title,
  link,
  icon,
  styles,
...
const Title = () => {
  ...
  return (
    <>
      <Head>
        <title>Kishore Gamidi - Software Engineer & Full-Stack Developer</title>
        <meta
          name="description"
          content="Kishore Gamidi's portfolio website."
        />
      ...
      <main
        className={
          "p-24 flex flex-col justify-center items-center h-screen gap-4"
        }
      >
        ...
        <div className={"flex flex-row gap-3 items-center"}>
          <TitleCTA
            title={"Let's Connect!"}
            link={"https://www.linkedin.com/in/kishoregamidi/"}
            icon={"link"}
